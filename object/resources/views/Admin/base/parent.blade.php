...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-blur-violate" style="background:url('/Admin/img/bg1.jpg');">

        <header id="header" class="media">
            <a href="" id="menu-toggle"></a> 
            <a class="logo pull-left" href="index.html">超级管理员</a>
        ...
        <section id="main" class="p-relative" role="main">
            ...
            <aside id="sidebar">
                ...
                <div class="side-widgets overflow">
                    ...
                    <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
                        ...
                        <ul class="dropdown-menu profile-menu">
                            <li><a href="">修改头像</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                            <li><a href="">个人信息</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                            <li><a href="">设置中心</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                            <li><a href="{{ url('admin/over') }}">退出</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                        </ul>
                        <h4 class="m-0">兄弟连lamp176</h4>
                        @刘增晖
                    </div>
                ...
                <ul class="list-unstyled side-menu">
                    <li class="active">
                        <a class="sa-side-home" href="/admin/demo3">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="{{ asset('/admin/users/create') }}">添加管理员</a></li>
                            <li><a href="{{ asset('/admin/users') }}">浏览管理员信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            ...
                            <li><a href="{{ asset('/admin/goods') }}">显示商品信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="{{ asset('/admin/category/create') }}">添加商品分类</a></li>
                            <li><a href="{{ asset('/admin/category') }}">查看分类</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-ui" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="{{ asset('/admin/order') }}">订单列表</a></li>
                            <li><a href="{{ asset('/admin/back') }}">退款订单</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-page" href="{{ url('/admin/problems') }}">
                            <span class="menu-item">问题反馈</span>
                        </a>
                        <ul class="list-unstyled menu-item">
                            <li><a href="{{ asset('/admin/problem') }}">问题反馈</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="{{ url('/admin/cllect') }}">收藏列表</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/links">显示友情链接信息</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/pays">显示支付信息</a></li>
                            <li><a href="/admin/pays/create">添加支付</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/comment">显示评论信息</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/replay">显示回复信息</a></li>
                            <li><a href="/admin/replay/create">添加回复</a></li>
                        </ul>
                    </li> 
                </ul>
            </aside>
