    ...
    <div class="block-area" id="text-input">
        ...
        <div class="row">
            <form action='/admin/goods/{{ $ob->id }}' method='post'>
                ...
                <div class="col-lg-6">
                    是否加入特价商品:<select class="form-control m-b-10" name='sale'>
                        <option value='1'@if($ob->sale ==1)selected @endif>否</option>
                        <option value='2'@if($ob->sale ==2)selected @endif>是</option>
                    </select>
                </div>
                <div class="col-lg-6">
                    当季特价:<input type="text" class="form-control m-b-10" placeholder="当季特价" name='te_price' value="{{ $ob->te_price }}">
                </div>
                <div class="col-lg-6">
                    库存:<input type="text" class="form-control m-b-10" placeholder="库存量" name='stock' value="{{ $ob->stock }}">
                </div>
                <div class="col-lg-6">
                    销售量:<input type="text" class="form-control m-b-10" placeholder="销售量" name='hot_level' value="{{ $ob->hot_level }}">
                </div>
                <div class="col-lg-6">
